  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        let data;
        try {
          const resGz = await fetch('/data/radiology_cached.json.gz?' + Date.now());
          ...
          console.warn('Fallback a .json sin comprimir para Radiología:', e);
        }
  ...
  return (
    <div className="radiology-portal">
      ...
      <div className="portal-layout">
        ...
        <aside
          className="portal-sidebar glass-card border-glow-indigo"
          style={{
        ...
        >
          <div className="sidebar-section-title text-glow-indigo" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
