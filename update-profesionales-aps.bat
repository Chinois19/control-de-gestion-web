@echo off
chcp 65001 > nul
title Actualizacion Consultas Profesionales No Medicos (RUP APS)

echo ================================================
echo  Consultas Profesionales No Medicos (RUP APS)
...
echo.
echo ================================================
echo  Archivo generado: public\data\profesionales_aps_cached.json
